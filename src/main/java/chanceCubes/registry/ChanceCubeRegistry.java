...
import net.minecraft.server.v1_10_R1.BlockWallSign;
...
public class ChanceCubeRegistry implements IRewardRegistry {
    ...
    public static void loadDefaultRewards() {
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Tnt_Structure", -30, new BlockRewardType(RewardsUtil.addBlocksLists(RewardsUtil.fillArea(3, 1, 3, Blocks.TNT, -1, 0, -1, true, 0, false, false), RewardsUtil.fillArea(3, 1, 3, Blocks.REDSTONE_BLOCK, -1, 1, -1, true, 30, false, false)))));
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":BedRock", -20, new BlockRewardType(new OffsetBlock(0, 0, 0, Blocks.BEDROCK, false))));
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Hearts", 0, new ParticleEffectRewardType(RewardsUtil.spawnXParticles(34, 5))));
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Explosion", 0, new ParticleEffectRewardType(new ParticlePart(2)), new SoundRewardType(new SoundPart(Sound.ENTITY_GENERIC_EXPLODE))));
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Sail_Away", 5, new BlockRewardType(new OffsetBlock(0, -1, 0, Blocks.WATER, false)), new CommandRewardType(new CommandPart("/summon Boat %x %y %z")), new MessageRewardType(new MessagePart("Come sail away!"))));
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Diamond_Block", 85, new BlockRewardType(new OffsetBlock(0, 0, 0, Blocks.DIAMOND_BLOCK, true, 200))));
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Anti_Slab", -15, new BlockRewardType(RewardsUtil.fillArea(3, 1, 3, Blocks.OBSIDIAN, -1, 2, -1, false, 0, false, true))));
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":chanceCube_Cube", -10, new MessageRewardType(new MessagePart("Hey, at least it isn't a Giant Chance Cube >:)")), new BlockRewardType(new OffsetBlock(-1, 0, -1, CCubesItems.getBlockOf(CCubesItems.chanceCube), false), new OffsetBlock(-1, 0, -2, CCubesItems.getBlockOf(CCubesItems.chanceCube), false), new OffsetBlock(-2, 0, -1, CCubesItems.getBlockOf(CCubesItems.chanceCube), false), new OffsetBlock(-2, 0, -2, CCubesItems.getBlockOf(CCubesItems.chanceCube), false), new OffsetBlock(-1, 1, -1, CCubesItems.getBlockOf(CCubesItems.chanceCube), false), new OffsetBlock(-1, 1, -2, CCubesItems.getBlockOf(CCubesItems.chanceCube), false), new OffsetBlock(-2, 1, -1, CCubesItems.getBlockOf(CCubesItems.chanceCube), false), new OffsetBlock(-2, 1, -2, CCubesItems.getBlockOf(CCubesItems.chanceCube), false))));
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":No", 0, new BlockRewardType(new OffsetBlock(0, 0, 0, CCubesItems.getBlockOf(CCubesItems.chanceCube), false)), new MessageRewardType(new MessagePart("No"))));
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Giant_chanceCube", -45, new BlockRewardType(RewardsUtil.fillArea(3, 3, 3, CCubesItems.getBlockOf(CCubesItems.chanceCube), -1, 0, -1, false, 0, true, false))), false);
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":STRING!", 7, new BlockRewardType(RewardsUtil.fillArea(11, 5, 11, Blocks.TRIPWIRE, -5, 0, -5, false, 0, false, true)), new MessageRewardType(new MessagePart("STRING!!!!"))));
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":D-rude_SandStorm", -10, new BlockRewardType(RewardsUtil.fillArea(5, 3, 5, Blocks.SAND, -2, 0, -2, true, 0, false, true)), new MessageRewardType(new MessagePart("Well that was D-rude").setDelay(40))));
        ...
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Watch_World_Burn", -5, new BlockRewardType(RewardsUtil.fillArea(7, 1, 7, Blocks.FIRE, -3, 0, -3, false, 0, true, true)), new MessageRewardType(new MessagePart("Some people just want to watch the world burn."))));
        INSTANCE.registerReward(new BasicReward(CCubesCore.instance().getId() + ":Coal_To_Diamonds", -35, new BlockRewardType(new OffsetBlock(0, 1, 0, Blocks.COAL_BLOCK, false), new OffsetBlock(0, -1, 0, Blocks.COAL_BLOCK, false), new OffsetBlock(1, 0, 0, Blocks.COAL_BLOCK, false), new OffsetBlock(-1, 0, 0, Blocks.COAL_BLOCK, false), new OffsetBlock(0, 0, 1, Blocks.COAL_BLOCK, false), new OffsetBlock(0, 0, -1, Blocks.COAL_BLOCK, false)), new CommandRewardType(RewardsUtil.executeXCommands("/summon PrimedTnt %x %y %z {Fuse:40}", 3, 5)), new ItemRewardType(new ItemPart(new ItemStack(Material.DIAMOND, 5), 50))));
        ...
        for (int i = 0; i < signs.length; i++) {
            ...
            temp.setBlockState(Blocks.WALL_SIGN.getBlockData().set(BlockWallSign.FACING, EnumDirection.fromType1(i + 2)));
            signs[i] = temp;
        }
